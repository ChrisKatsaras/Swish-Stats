                        ...
                        <div className="row">
                            <div className="col-8 text-light" style={cardInfoSection}>
                                <div className="column">
                                    <img style={teamIcon} src={this.props.logo}></img>
                            ...
                            <div className="col-4" style={cardStatisticSection}>
                                <div className="column">
                                    <p className="text-light" style={cardDate}>2018/ 2019</p>
                                    <h3 className="h3 text-light">{this.props.statistic}</h3>
                                    <p className="text-light" style={cardCategory}>{this.props.categoryAbbreviation}</p>
